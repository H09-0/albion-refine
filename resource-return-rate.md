...
- Example: At 53.9% RRR with 100 planks input, you'd get ~54 planks back on average
...
- **General bonus**: Up to +26% from Power Cores
- **Specialized bonus**: Up to +30% from Power Cores
- **Total potential**: 15 + 26 + 30 = 71% + Focus 59% = 130%
